...
export default function Footer() {
   ...
   return (
      <footer className="bg-black py-8">
         <div className="mx-auto px-3 grid grid-cols-2 gap-15 container">
            <div>
               <h2 className="text-white mb-2 font-bold">&quot;Кинематография&quot;</h2>
               ...
               <ul className="flex gap-3 flex-col mt-2 text-sm mb-3">
                  <li className="flex items-center gap-2">
                     ...
                     <span className="text-gray-500">Москва, Всеволожский пер., 3</span>
                  </li>
                  <li className="flex items-center gap-2">
                     <Phone color="#6a7282" size={18} />
                     <span className="text-gray-500">+7 (495) 123-45-66</span>
                  </li>
                  <li className="flex items-center gap-2">
                     <Mail color="#6a7282" size={18} />
                     <span className="text-gray-500">info@tk.ru</span>
                  </li>
               </ul>
            </div>
            <div>
               ...
               <nav>
                  <ul className="flex flex-col gap-3">
                     ...
                     <li>
                        <Link href="/perspective" className="text-gray-500 text-sm">Перспективная программа работы ТК</Link>
                     </li>
                     <li>
                        <Link href="/projects" className="text-gray-500 text-sm">Проекты стандартов</Link>
                     </li>
                     <li>
         ...
         <p className="text-gray-500 text-center text-sm">&copy; “Кинематография” ТК NNN, {currentYear}г.</p>
      </footer>
   )
}