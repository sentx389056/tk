...
export default function ProjectsPage() {
   const nationalStandards = [
      ...
      },
      {
         id: 5,
         code: "ГОСТ 9039-73",
         title: "Насадки анаморфотные для кинопроекционных объективов. Технические условия",
      },
      {
         id: 6,
         code: "ГОСТ 9040-81",
         title: "Блоки анаморфотные киносъемочные и насадки анаморфотные к киносъемочным объективам для съемки 35-мм широкоэкранных фильмов. Общие технические условия",
      },
      {
         id: 7,
         code: "ГОСТ 11079-76",
      ...
      },
      {
         id: 8,
         code: "ГОСТ 13137-82",
         title: "Аппараты кинокопировальные для контактной печати 70-, 35- и 16-мм кинофильмов. Экспонируемые поля. Размеры и расположение. Методы контроля",
      },
      {
         id: 9,
         code: "ГОСТ 17706-83",
         title: "Кинопроекторы и киноустановки для 70-, 35- и 16-мм кинофильмов. Размеры и расположение проецируемых полей. Методы контроля",
      },
      {
         id: 10,
         code: "ГОСТ 17813-90",
      ...
      },
      {
         id: 16,
         code: "ГОСТ 26018-83",
         title: "Аппараты кинокопировальные для оптической печати 70-, 35- и 16-мм кинофильмов. Размеры и расположение просвечиваемых и экспонируемых полей, методы контроля",
      },
      {
         id: 17,
         code: "ГОСТ 26157-84",
